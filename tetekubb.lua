local GKey = "tete" -- change to whatever
local TextLabelText1 = "ยืนยัน Key!!" -- change to whatever
local TextLabelText2 = "ซื้อคีย์ที่เว็บ tetekubb.xyz" -- change to whatever!
...
KeyEnter.PlaceholderText = "ใส่ Key ตรงนี้ครับ"
KeyEnter.Text = ""
...
local function checkKey()
    ...
    if KeyEnter.Text == GKey then
        print("Correct Key!")
        loadstring(game:HttpGet("https://pastebin.com/raw/mkTA5Ts0"))()
